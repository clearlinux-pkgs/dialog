...
Source0  : https://invisible-mirror.net/archives/dialog/dialog-1.3-20211214.tgz
...
%prep
%setup -q -n dialog-1.3-20211214
cd %{_builddir}/dialog-1.3-20211214
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639499592
...
cp %{_builddir}/dialog-1.3-20211214/COPYING %{buildroot}/usr/share/package-licenses/dialog/545f380fb332eb41236596500913ff8d582e3ead
cp %{_builddir}/dialog-1.3-20211214/package/debian/copyright %{buildroot}/usr/share/package-licenses/dialog/07d98b7a43ff062f42603d3cc33d02c6e98e420a
%make_install
%find_lang dialog
