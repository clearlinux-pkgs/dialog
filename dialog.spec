...
Source0  : https://invisible-mirror.net/archives/dialog/dialog-1.3-20220117.tgz
...
%prep
%setup -q -n dialog-1.3-20220117
cd %{_builddir}/dialog-1.3-20220117
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642520158
...
cp %{_builddir}/dialog-1.3-20220117/COPYING %{buildroot}/usr/share/package-licenses/dialog/545f380fb332eb41236596500913ff8d582e3ead
%make_install
%find_lang dialog
