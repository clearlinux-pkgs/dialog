...
%setup -q -n dialog-1.3-20250116
cd %{_builddir}/dialog-1.3-20250116
pushd ..
cp -a dialog-1.3-20250116 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737132990
...
cp %{_builddir}/dialog-1.3-20250116/COPYING %{buildroot}/usr/share/package-licenses/dialog/545f380fb332eb41236596500913ff8d582e3ead || :
export GOAMD64=v2
GOAMD64=v3
pushd ../buildavx2/
%make_install_v3
