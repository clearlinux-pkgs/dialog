...
Source0  : https://invisible-mirror.net/archives/dialog/dialog-1.3-20221229.tgz
...
%prep
%setup -q -n dialog-1.3-20221229
cd %{_builddir}/dialog-1.3-20221229
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672414487
...
cp %{_builddir}/dialog-1.3-20221229/COPYING %{buildroot}/usr/share/package-licenses/dialog/545f380fb332eb41236596500913ff8d582e3ead || :
cp %{_builddir}/dialog-1.3-20221229/package/debian/copyright %{buildroot}/usr/share/package-licenses/dialog/d4dae61ed985437566aece1432d58dfa171cd201 || :
%make_install
%find_lang dialog
